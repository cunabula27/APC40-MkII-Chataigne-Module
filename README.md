...
> [!WARNING]
> Due to the dynamic way pads and knobs are created by this module (including on reloading a Noisette), trying to use the Router in Chataigne ***with this module*** will cause a crash.
