...
> [!WARNING]
> Due to the dynamic way pads and knobs are created (including on reloading a Noisette), trying to use the Router in Chataigne ***with this module*** will cause a crash.
